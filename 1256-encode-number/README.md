<h2><a href="https://leetcode.com/problems/encode-number/">1256. Encode Number</a></h2><h3>Medium</h3><hr><div><p>Given a non-negative integer <code>num</code>, Return its <em>encoding</em> string.</p>
